...
const experiences: Experience[] = [
    ...
    },
    {
        ...
        description: "Evaluating seed-stage B2B SaaS for a $60M fund. Diligence on 100+ companies across unit economics, market structure, and exit viability.",
    ...
    },
    {
        ...
        description: "TMT equity research for the $120K Ewing-Schleeter Harris Fund. DCF models, WACC, and public comps behind buy/sell calls. 1 of 12 from 170+ applicants.",
...
const projects: Project[] = [
    ...
    },
    {
        ...
        role: "Builder",
        description: "A competition-rocket design and flight-review workbench: vehicle geometry, motors, drag models, launch conditions, and the evidence behind every result.",
        tech: "Rust • Tauri • React • Flight Simulation",
        featured: true,
    },
    {
        ...
        role: "Author",
        description: "Economics paper arguing AI has weakened the computational constraint on planning, while the binding risks stay institutional: oversight, concentration, accountability.",
    ...
    },
    {
        ...
        role: "Team Lead",
        description: "Portable speech-to-Braille printer for deafblind accessibility. Won 'Most Innovative Idea' at Penn M&TSI.",
    ...
    return (
        <InteractiveItem index={index} accentColor="amber" dataTour={`experience-card-${index}`}>
            <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5 mb-1">
                ...
                <span className="t-meta text-cyan-400 group-hover:text-cyan-300 transition-colors">{exp.role}</span>
                <span className="t-label t-num text-gray-500 ml-auto group-hover:text-gray-400 transition-colors">{exp.date}</span>
            </div>
            <p className="t-meta measure text-gray-400 mb-1.5 group-hover:text-gray-300 transition-colors">
                {exp.description}
            </p>
            <div className="flex flex-wrap items-center gap-x-3 t-tag text-gray-500 group-hover:text-gray-400 transition-colors">
    ...
    return (
        <InteractiveItem index={index} accentColor="cyan" dataTour={index === 0 ? "project-0" : undefined}>
            <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5 mb-1">
                ...
                <span className="t-meta text-cyan-400 group-hover:text-cyan-300 transition-colors">{project.role}</span>
                <span className="t-label text-gray-500 ml-auto group-hover:text-gray-400 transition-colors">{project.category}</span>
            </div>
            <p className="t-meta measure text-gray-400 mb-1.5 group-hover:text-gray-300 transition-colors">
                {project.description}
            </p>
            <div className="t-tag text-gray-500 group-hover:text-gray-400 transition-colors">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
                    ...
                    <div data-tour="experience">
                        ...
                        {restCount > 0 && (
                            <button
                                ...
                                className="group mt-4 flex items-center gap-2 t-label text-gray-500 hover:text-amber-400 transition-colors"
                            >
                    ...
                    <div data-tour="projects">
                        ...
                        {remainingProjectCount > 0 && (
                            <button
                                onClick={() => setShowAll((v) => !v)}
                                className="group mt-4 flex items-center gap-2 t-label text-gray-500 hover:text-cyan-400 transition-colors"
                            >
